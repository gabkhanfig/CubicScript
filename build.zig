...
pub const cubic_script_c_sources = [_][]const u8{
    ...
    "src/compiler/ast.c",
    "src/compiler/parse/tokenizer.c",
    "src/compiler/parse/parse_statements.c",
    "src/compiler/parse/type_resolution_info.c",
    ...
    "src/compiler/ast_nodes/variable_assignment.c",
    "src/compiler/ast_nodes/expression_value.c",
    "src/compiler/ast_nodes/struct_node.c",
    "src/compiler/ast_nodes/member_variable.c",
    "src/compiler/ast_nodes/conditional_node.c",
    ...
    "src/compiler/errors/cannot_find_symbol.c",
